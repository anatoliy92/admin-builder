			...
			saveTable: function (e) {
				...
				$.ajax({
						...
						data : {
							...
							hidenRows: JSON.stringify(this.hidenRows),
							hidenCols: JSON.stringify(this.hidenCols),
							graph: this.graph
						},
				...
				$.ajax({
					...
					success: function(data) {
						if (data.errors) {
							...
							self.graph = data.graph;
							self.hidenRows = data.config.hidenRows;
							self.hidenCols = data.config.hidenCols;
				...
				tinymce.init({
					...
					setup: function (editor) {
						editor.on('keyup', function() {
							self.settings.descriptions[node][lang] = editor.getContent();
						});
					}
				});
			},
